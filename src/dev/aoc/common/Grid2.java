...
public class Grid2<T> {
    ...
    public Grid2(List<String> lines, String elementDelimiter, Function<String, T> parser, Supplier<Class<?>> classSupplier) {
        this(
    ...
    public Grid2(int width, int height, T fillElement, String elementDelimiter) {
        this(emptyGrid(width, height, fillElement), width, height, elementDelimiter);
    }
    public Grid2(int width, int height, T fillElement, Class<?> anElementClass, String elementDelimiter) {
    ...
    private Grid2(T[][] elements, int width, int height, String elementDelimiter) {
    ...
    public static class GridTest {
        @Test
        void test() {
            Grid2<Integer> intGrid = new Grid2<>(2, 2, -1, ", ");
